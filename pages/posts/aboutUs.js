...
//         {/* <Image
//           src="/images/mypost.png" // 你需要放一张图片到 public/images/profile.jpg
//           alt="作者头像"
//           width={160}
//           height={160}
...
//         /> */}
//         <h1 style={{ marginTop: '1rem' }}>👋 你好，我是作者</h1>
//         <p style={{ maxWidth: '400px', margin: '1rem auto', fontSize: '1.1rem' }}>
//           我是来自南开大学计算机学院的大三学生，目前正在开发一个基于 Next.js+React 和 MySQL 的校园论坛系统，
//           支持用户注册、登录、发帖、点赞、权限控制等功能。
//           喜欢的朋友们可以移步我的Github主页，点个star哦~
//         </p>
//       </div>
//     </Layout>
//   );
